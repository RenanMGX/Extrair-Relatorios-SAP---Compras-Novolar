...
class Logs:
    ...
    def register(self, *, status:Literal['Error', 'Concluido', 'Report'], description:str="", exception:str|None=traceback.format_exc(), file:str="Logs_Operation.csv", date_format:str='%d/%m/%Y %H:%M:%S'):
